...
import com.kylin.electricassistsys.service.project.BdzGzGcService;
 ...
 */
@Controller
@RequestMapping("/project/bdzgzgc")
public class BdzGzGcController extends BaseController<BdzGzGcEntity, BdzGzGcService>
{
    @Autowired
    KeyValueService keyValueService;

    @Autowired
    public void setService(BdzGzGcService service)
    {
    ...
    {
        AutoBuilderParam autoBuilderParam =new AutoBuilderParam("变电站改造工程", "/project/bdzgzgc", "500px", "1200px", 1);
        this.setAutoBuilderParam(autoBuilderParam);
    }

    protected  String getEditUrl()
    {
        return "project/bdzgzgcEdit";
    }

    protected  void buildEdit(Model model, BdzGzGcEntity entity,String type)
    {
