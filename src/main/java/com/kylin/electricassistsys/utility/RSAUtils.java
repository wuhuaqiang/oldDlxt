...
public class RSAUtils {
     ...
     * @return 原文字符串。
     */
    public String decryptString(String encrypttext, RSAPrivateKey rsaPrivateKey) {
     ...
     */
    public String decryptStringByJs(String encrypttext, RSAPrivateKey rsaPrivateKey) {
        String text = decryptString(encrypttext,rsaPrivateKey);
        if(text == null) {
            return null;
        }
    ...
    public void buildRsaModelParam(HttpServletRequest request, Model model)
    {
