...
@Table(name="Xmqc")
public class BdzGzGcEntity extends BaseEntity
{
    ...
    @FieldMeta(description = "变压器改造数(台)",index =14)
    private int byqgzts;

    @FieldMeta(description = "改造变压器编号1",index =15)
    private String gzbyqbh1="";

    @FieldMeta(description = "改造变压器编号2",index =16)
    private String gzbyqbh2="";

    @FieldMeta(description = "改造前主变容量(兆伏安)",index =17)
    private float gzqzbrl;

    @FieldMeta(description = "改造后主变容量(兆伏安)",index =18)
    private float gzhzbrl;

    @FieldMeta(description = "断路器",index =19)
    private int dlq;

    @FieldMeta(description = "其他项",index =20)
    private String qtx="";

    @FieldMeta(description = "其它项投资(万元)",index =22)
    private float qtxtz;

    @FieldMeta(description = "电源送出类型",index =23)
    private String dysclx="";

    @FieldMeta(description = "中央计划(%)",index =24)
    private float zyjh;

    @FieldMeta(description = "公司自筹(%)",index =25)
    private float gszc;

    @FieldMeta(description = "县级供电企业自筹(%)",index =26)
    private float xjgdqyzc;

    @FieldMeta(description = "用户投资(%)", index = 27)
    private float yhtz;

    @FieldMeta(description = "小区配套费(%)", index = 28)
    private float xqptf;

    @FieldMeta(description = "政府垫资(%)", index = 29)
    private float zfdz;

    @FieldMeta(description = "其他投资(%)", index = 30)
    private float qttz;

    @FieldMeta(description = "類型",show =false,index = 31,isExport = false, isImport = false)
    private int type;
    ...
    public int getByqgzts()
    {
        return byqgzts;
    }

    public void setByqgzts(int byqgzts)
    {
        this.byqgzts = byqgzts;
    }

    public String getGzbyqbh1()
    {
        return gzbyqbh1;
    }

    public void setGzbyqbh1(String gzbyqbh1)
    {
        this.gzbyqbh1 = gzbyqbh1;
    }

    public String getGzbyqbh2()
    {
        return gzbyqbh2;
    }

    public void setGzbyqbh2(String gzbyqbh2)
    {
        this.gzbyqbh2 = gzbyqbh2;
    }

    public float getGzqzbrl()
    {
        return gzqzbrl;
    }

    public void setGzqzbrl(float gzqzbrl)
    {
        this.gzqzbrl = gzqzbrl;
    }

    public float getGzhzbrl()
    {
        return gzhzbrl;
    }

    public void setGzhzbrl(float gzhzbrl)
    {
        this.gzhzbrl = gzhzbrl;
    }
