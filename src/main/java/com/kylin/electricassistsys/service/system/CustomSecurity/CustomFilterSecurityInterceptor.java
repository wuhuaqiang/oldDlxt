...
//        Collection<ConfigAttribute> configAttributes = this.customInvocationSecurityMetadataSourceService.getAttributes(fi);
//         this.getAccessDecisionManager().decide(token.getSecurityContext().getAuthentication(),fi,configAttributes);
        try {
            //执行下一个拦截器
