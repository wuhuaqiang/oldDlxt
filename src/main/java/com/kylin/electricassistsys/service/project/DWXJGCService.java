...
import com.kylin.electricassistsys.mapper.project.DWXJGCMapper;
 ...
 */
@Service
public class DWXJGCService extends BaseService<DwXjGcEntity>
{
    private DWXJGCMapper mapper;

    @Autowired
    KeyValueService keyValueService;

    @Autowired
    public void setMapper(DWXJGCMapper mapper)
    {
        this.mapper = mapper;
     ...
     * @param entity
     */
    protected void specialProcessForField(DwXjGcEntity entity,String type)
    {
