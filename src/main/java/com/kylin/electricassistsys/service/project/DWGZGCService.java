...
import com.kylin.electricassistsys.mapper.project.DWGZGCMapper;
 ...
 */
@Service
public class DWGZGCService extends BaseService<DwGzGcEntity>
{
    private DWGZGCMapper mapper;

    @Autowired
    KeyValueService keyValueService;

    @Autowired
    public void setMapper(DWGZGCMapper mapper)
    {
        this.mapper = mapper;
     ...
     * @param entity
     */
    protected void specialProcessForField(DwGzGcEntity entity,String type)
    {
